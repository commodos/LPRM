function [G,T] = lrm_fd(U,Y,lines,LRM,d,bw,Tr,fs)
...
for k = lines    
    if 1>k-floor(bw/2)
        [r POLY  POLY_T POLY_Y] = lpm_create_polynomials(k,lines,LRM,d,bw,Tr,Ni);
